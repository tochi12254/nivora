...
export const mockSystemTelemetryData: SystemTelemetryData = {
  systemOverview: [
    {
      title: "CPU Usage",
      value: "48.4%",
...
export const detectThreats = (data: SystemTelemetryData): AnomalyItem[] => {
...
export const enrichTelemetryWithThreatData = (data: SystemTelemetryData): SystemTelemetryData => {
