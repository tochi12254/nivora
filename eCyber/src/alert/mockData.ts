...
export const activeThreatCounts: ThreatCount[] = [
...
export const networkTrafficData: NetworkTraffic[] = Array.from({ length: 24 }, (_, i) => {
...
export const recentCriticalAlerts: ThreatDetection[] = [
  {
    id: "T-CR-001",
...
export const phishingDetections: PhishingDetection[] = [
  {
...
export const httpActivities: HttpActivity[] = [
  {
    id: "http-001",
...
export const dnsActivities: DnsActivity[] = [
  {
    id: "dns-001",
...
export const packetAnalyses: PacketAnalysis[] = [
  {
    id: "pkt-001",
...
export const ipv6Activities: IPv6Activity[] = [
  {
    id: "ipv6-001",
...
export const threatResponses: ThreatResponse[] = [
  {
    id: "resp-001",
...
export const quarantinedFiles: QuarantinedFile[] = [
  {
    id: "quar-001",
    timestamp: "2025-05-16T15:34:15Z",
