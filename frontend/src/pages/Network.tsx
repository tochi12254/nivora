        ...
        <main className="flex-1 overflow-auto p-6">
          <div className="max-w-7xl mx-auto">
            ...
            <Card className="mb-6">
              ...
              <CardContent>
                <div className="h-[400px] border border-border rounded-lg flex items-center justify-center bg-background/50">
                  <div className="text-center">
                    <Globe className="mx-auto mb-4 text-muted-foreground" size={48} />
                    <p className="text-muted-foreground">Interactive network map visualization</p>
                    <Button variant="outline" size="sm" className="mt-4">View Full Screen</Button>
                  </div>
                </div>
              </CardContent>
            </Card>
