...
from app.models.packet import Packets
from app.core.security import get_current_user
from app.services.detection.rate_limiter import RateLimiter
from app.services.prevention.firewall import FirewallManager
from app.services.detection.signature import SignatureEngine
from app.services.detection.detect_port_scan import PortScanDetector
...
if __name__ == "__main__":
    ...
    sniffer = PacketSniffer(sio, main_loop)
    sniffer.start('Wi-Fi')
    logger.info(f"Started packet sniffer on Wi-Fi")
